...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	float k = 1.4E-5; // Річовий тип

	double n = 1.5E-105; // Річовий тип подвійної довжини

	char symbol = 'g'; // Символьний тип

	std::string line = "Стрічка символів"; // Рядковий тип

	bool logic = true; // Логічний тип (приймає значення тільки true або false)

	std::cout<<"Цілочисельна змінна: "<<i<<std::endl; //Розміщення змінної i в потоці виведення
	std::cout<<"Річова змінна: "<<k<<std::endl;
	std::cout<<"Річова змінна подвійної довжини: "<<n<<std::endl;
	std::cout<<"Символьна змінна: "<<symbol;
	std::cout<<std::endl; // Розміщення std::endl в потоці виведення переводить курсор на новий рядок
						  // (аналогічно "\n" в рядку символів)
	std::cout<<"Рядкова змінна: "<<line; // Розміщення змінної line  в потоці виведення
    std::cout<<std::endl<<"Логічна змінна: "<<logic;
